        ...
        <form className="gameForm">
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <select name="gameTypeId" className="form-control" onChange={handleControlledInputChange} >
                        <option value="0">select a game type</option>
                        {
                            gameTypes.map(gtype =>{
                                return <option key={gtype.id} value={gtype.id}>{gtype.label}</option>
                            })
                        }
                    </select>
                </div>
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <select name="skillLevel" className="form-control" onChange={handleControlledInputChange} >
